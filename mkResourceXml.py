...
CSV_EXCEPT = ["list.csv", "tokei.csv", "eikianim.csv", "EagloV_11.csv", "EagloV_22.csv", "EagloV_49.csv", "EagloV_61.csv", "EagloV_62.csv", "EagloV_72.csv", "EagloV_断面.csv", "xray.csv", "拼接.csv"]
