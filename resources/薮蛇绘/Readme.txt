原图片规约/元画像規約/Original Image Protocol：
この立ち絵は東方projectの二次創作物となります、まず公式様の規約を順守するようにしてください
東方Projectの二次創作ガイドライン→【https://touhou-project.news/guideline/】
本配布物は東方幻想郷、夢月 幻月の立ち絵となります
1.商用利用、再配布は禁止とさせていただきます。ただしYouTube、ニコニコでの公的なシステムを用いた収益化については商用利用とみなさず、収益化を許可します。
2.加工、加筆は可能とします。
3.使用するにあたり製作者に報告する必要はありません。またクレジット表記は出来ればしてほしいですが必須ではありません
・配布物に問題がありましたら製作者のTwitterアカウントにリプライなどでご連絡ください
　製作者　藪蛇のTwitter　（@yabuhebi1067）
